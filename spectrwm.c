...
#ifdef SWM_DEBUG
		if (win)
			DNPRINTF(SWM_D_MISC, "found child %#x of %#x.\n",
			    win->id, qtr->parent);
#endif
...
keypress(xcb_key_press_event_t *e)
{
	...
	DNPRINTF(SWM_D_EVENT, "keysym: %u, win (x,y): %#x (%d,%d), detail: %u, "
	    "time: %u, root (x,y): %#x (%d,%d), child: %#x, state: %u, "
...
buttonpress(xcb_button_press_event_t *e)
{
	...
	DNPRINTF(SWM_D_EVENT, "win (x,y): %#x (%d,%d), detail: %u, time: %u, "
...
enternotify(xcb_enter_notify_event_t *e)
{
	...
	DNPRINTF(SWM_D_FOCUS, "time: %u, win (x,y): %#x (%d,%d), mode: %s(%d), "
...
motionnotify(xcb_motion_notify_event_t *e)
{
	...
	DNPRINTF(SWM_D_FOCUS, "time: %u, win (x,y): %#x (%d,%d), "
	    "detail: %s(%d), root (x,y): %#x (%d,%d), child: %#x, "
